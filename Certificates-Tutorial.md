...
The CN field could be any string. In the "hosts" field, by default it is ["127.0.0.1","localhost"]. We added our Network server’s public IP here, which is as follow : ["127.0.0.1","localhost","192.168.1.3"] )
