...
"hosts": [YOUR_NETWORK_SERVER_HOST_IP_ADDRESSES], (by default : ["127.0.0.1","localhost"], we added our server’s public IP here, ours is as follow : ["127.0.0.1","localhost","192.168.1.3"] )
