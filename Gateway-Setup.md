 ...
 * Once can get the IP address as explained [here], thus enabling to connect to the RGW via SSH or the Web interface
...
In the event of one using RGW that is not Multitech Conduit, please make sure that you verify the [Post Sanity check] for your RGW. Once verified, Next section to follow : [NS-Setup]

If you are using Multitech mDot and you have verified accessing the ED by following the page, Next section to follow : [NS-Setup]
